...
asset_setup="${repo_root}/scripts/setup/setup_external_assets.sh"
if [[ ! -f "${asset_setup}" ]]; then
  asset_setup="${repo_root}/github_release_template/scripts/setup/setup_external_assets.sh"
fi
...
printf '  bash scripts/pipeline/run_full_pipeline.sh\n'
